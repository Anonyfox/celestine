...
describe('Koch Houses', () => {
  ...
  describe('Basic Structure', () => {
    it('should have House 1 = ASC', () => {
      const asc = 15;
      const mc = 285;
      const cusps = kochHouses(asc, mc, 40, obliquity);
    ...
    it('should return exactly 12 cusps', () => {
      const cusps = kochHouses(15, 285, 40, obliquity);
  ...
  describe('Moderate Latitudes', () => {
    it('should work at equator', () => {
      const cusps = kochHouses(0, 270, 0, obliquity);
    ...
    it('should work at 50° latitude', () => {
      const cusps = kochHouses(15, 285, 51.5, obliquity);
    ...
    it('should work in Southern hemisphere', () => {
      const cusps = kochHouses(195, 105, -33.87, obliquity);
  ...
  describe('High Latitudes', () => {
    it('should work at 60° latitude', () => {
      const cusps = kochHouses(45, 315, 60, obliquity);
    ...
    it('should fall back to Porphyry above 66° latitude', () => {
      const cusps = kochHouses(15, 285, 70, obliquity);
  ...
  describe('House Progression', () => {
    it('should have cusps in ascending order', () => {
      const cusps = kochHouses(45, 315, 40, obliquity);
