...
// Query: COMMAND='599', EPHEM_TYPE='OBSERVER', CENTER='500@399', QUANTITIES='31'
// Retrieved: 2025-Dec-19
// These values are AUTHORITATIVE - do not modify!
// =============================================================================
const JPL_JUPITER_REFERENCE = [
  { jd: 2451545.0, description: 'J2000.0', longitude: 25.2530685, latitude: -1.2621868 },
  { jd: 2458850.0, description: '2020-Jan-01 12:00', longitude: 276.785542, latitude: 0.0878157 },
  { jd: 2448058.0, description: '1990-Jun-15 12:00', longitude: 105.8894762, latitude: 0.1856219 },
] as const;
...
describe('ephemeris/planets/jupiter', () => {
  ...
  describe('getJupiterPosition', () => {
    describe('JPL Horizons reference validation', () => {
      for (const ref of JPL_JUPITER_REFERENCE) {
        it(`should match JPL Horizons at ${ref.description}`, () => {
          ...
          assert.ok(
            ...
            `Longitude: expected ${ref.longitude}° (JPL), got ${jupiter.longitude.toFixed(4)}° (diff: ${(lonDiff * 60).toFixed(1)} arcmin)`,
          );
        });
      }
    });
