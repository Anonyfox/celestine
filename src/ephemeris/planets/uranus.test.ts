...
// Query: COMMAND='799', EPHEM_TYPE='OBSERVER', CENTER='500@399', QUANTITIES='31'
// Retrieved: 2025-Dec-19
// These values are AUTHORITATIVE - do not modify!
// =============================================================================
const JPL_URANUS_REFERENCE = [
  { jd: 2451545.0, description: 'J2000.0', longitude: 314.809168, latitude: -0.658324 },
  { jd: 2458850.0, description: '2020-Jan-01 12:00', longitude: 32.6897768, latitude: -0.4934497 },
  { jd: 2448058.0, description: '1990-Jun-15 12:00', longitude: 278.1651968, latitude: -0.3237725 },
] as const;
...
describe('ephemeris/planets/uranus', () => {
  ...
  describe('getUranusPosition', () => {
    describe('JPL Horizons reference validation', () => {
      for (const ref of JPL_URANUS_REFERENCE) {
        it(`should match JPL Horizons at ${ref.description}`, () => {
          ...
          assert.ok(
            ...
            `Longitude: expected ${ref.longitude}° (JPL), got ${uranus.longitude.toFixed(4)}° (diff: ${(lonDiff * 60).toFixed(1)} arcmin)`,
          );
        });
      }
    });
