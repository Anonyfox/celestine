...
// Query: EPHEM_TYPE='OBSERVER', CENTER='500@399', QUANTITIES='31'
// Retrieved: 2025-Dec-19
// These values are AUTHORITATIVE - do not modify!
// =============================================================================
const JPL_SUN_REFERENCE = [
  { jd: 2451545.0, description: 'J2000.0', longitude: 280.3689092, latitude: 0.0002381 },
  { jd: 2458850.0, description: '2020-Jan-01 12:00', longitude: 280.5192141, latitude: -0.0001245 },
  { jd: 2448058.0, description: '1990-Jun-15 12:00', longitude: 84.1295425, latitude: 0.0001101 },
] as const;
...
describe('ephemeris/sun', () => {
  ...
  describe('getSunPosition', () => {
    describe('JPL Horizons reference validation', () => {
       ...
       */
      for (const ref of JPL_SUN_REFERENCE) {
        it(`should match JPL Horizons at ${ref.description}`, () => {
          ...
          assert.ok(
            ...
            `Longitude: expected ${ref.longitude}° (JPL), got ${sun.longitude.toFixed(4)}° (diff: ${(lonDiff * 60).toFixed(1)} arcmin)`,
          );
        });
      }
    });
